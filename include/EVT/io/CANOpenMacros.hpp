...
#define PDO_TRIGGER_SYNC 0x00
#define PDO_TRIGGER_ASYNC 0xFE
 ...
 * @param TRANSMISSION_TYPE the type of transmission to make. You should use PDO_TRIGGER_SYNC or PDO_TRIGGER_ASYNC.
*/
 ...
 * is the RPDO Number.
 *
 * This function takes in two parameters, the RPDO number which is used to create
 ...
 */
#define RPDO_N_MAPPING_ENTRY_N_160X(RPDO_NUMBER, SUB_INDEX, DATA_SIZE)                  \
    {                                                                                   \
